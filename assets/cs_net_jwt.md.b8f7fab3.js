...
<span class="line"><span style="color:#A6ACCD;">        &lt;div&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">            &lt;span&gt;账号&lt;/span&gt; &lt;input id=&quot;name&quot; type=&quot;text&quot;&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">        &lt;/div&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">        &lt;div&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">            &lt;span&gt;密码&lt;/span&gt; &lt;input id=&quot;password&quot; type=&quot;password&quot;&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">        &lt;/div&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">        &lt;button id=&quot;btn&quot;&gt;登录&lt;/button&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;/div&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;script&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">        const btn = document.querySelector(&#39;#btn&#39;)</span></span>
<span class="line"><span style="color:#A6ACCD;">        const name = document.querySelector(&#39;#name&#39;)</span></span>
<span class="line"><span style="color:#A6ACCD;">        const password = document.querySelector(&#39;#password&#39;)</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">        btn.onclick = () =&gt; {</span></span>
<span class="line"><span style="color:#A6ACCD;">            fetch(&#39;http://localhost:3000/api/login&#39;, {</span></span>
<span class="line"><span style="color:#A6ACCD;">                body: JSON.stringify({</span></span>
<span class="line"><span style="color:#A6ACCD;">                    name: name.value,</span></span>
<span class="line"><span style="color:#A6ACCD;">                    password: password.value</span></span>
<span class="line"><span style="color:#A6ACCD;">                }),</span></span>
...
<span class="line"><span style="color:#A6ACCD;">            }).then(res =&gt; res.json()).then(res =&gt; {</span></span>
<span class="line"><span style="color:#A6ACCD;">                localStorage.setItem(&#39;token&#39;, res.token)</span></span>
<span class="line"><span style="color:#A6ACCD;">                location.href = &#39;./list.html&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">            })</span></span>
<span class="line"><span style="color:#A6ACCD;">        }</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;/script&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;/body&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;!-- 具体调用接口 --&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    &lt;meta charset=&quot;UTF-8&quot;&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;meta name=&quot;viewport&quot; content=&quot;width=device-width, initial-scale=1.0&quot;&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;title&gt;List&lt;/title&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;/head&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;body&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;script&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">        console.log(localStorage.getItem(&#39;token&#39;))</span></span>
<span class="line"><span style="color:#A6ACCD;">        fetch(&#39;http://localhost:3000/api/list&#39;, {</span></span>
<span class="line"><span style="color:#A6ACCD;">            headers: {</span></span>
<span class="line"><span style="color:#A6ACCD;">                &#39;Authorization&#39;:\`Bearer \${localStorage.getItem(&#39;token&#39;)}\`</span></span>
<span class="line"><span style="color:#A6ACCD;">            }</span></span>
<span class="line"><span style="color:#A6ACCD;">        }).then(res =&gt; res.json()).then(res =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">let user = { name: &#39;admin&#39;, password: &#39;123456&#39;, id: 1 } //模拟用户信息</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">app.post(&#39;/api/login&#39;, (req, res) =&gt; {</span></span>
<span class="line"><span style="color:#A6ACCD;">    console.log(req.body)</span></span>
<span class="line"><span style="color:#A6ACCD;">    if (req.body.name == user.name &amp;&amp; req.body.password == user.password) {</span></span>
<span class="line"><span style="color:#A6ACCD;">        res.json({</span></span>
<span class="line"><span style="color:#A6ACCD;">            message: &#39;登录成功&#39;,</span></span>
<span class="line"><span style="color:#A6ACCD;">            code: 200,</span></span>
<span class="line"><span style="color:#A6ACCD;">            token: jwt.sign({ id: user.id }, secretKey, { expiresIn: 60 * 60 * 24 }) //生成token</span></span>
<span class="line"><span style="color:#A6ACCD;">        })</span></span>
<span class="line"><span style="color:#A6ACCD;">    } else {</span></span>
<span class="line"><span style="color:#A6ACCD;">        res.json({</span></span>
<span class="line"><span style="color:#A6ACCD;">            message: &#39;登录失败&#39;,</span></span>
<span class="line"><span style="color:#A6ACCD;">            code: 400</span></span>
<span class="line"><span style="color:#A6ACCD;">        })</span></span>
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">app.get(&#39;/api/list&#39;, (req, res) =&gt; {</span></span>
<span class="line"><span style="color:#A6ACCD;">    console.log(req.headers.authorization)</span></span>
<span class="line"><span style="color:#A6ACCD;">    jwt.verify(req.headers.authorization as string, secretKey, (err, data) =&gt; { //验证token</span></span>
<span class="line"><span style="color:#A6ACCD;">        if (err) {</span></span>
<span class="line"><span style="color:#A6ACCD;">            res.json({</span></span>
<span class="line"><span style="color:#A6ACCD;">                message: &#39;token失效&#39;,</span></span>
<span class="line"><span style="color:#A6ACCD;">                code: 403</span></span>
<span class="line"><span style="color:#A6ACCD;">            })</span></span>
<span class="line"><span style="color:#A6ACCD;">        } else {</span></span>
<span class="line"><span style="color:#A6ACCD;">            res.json({</span></span>
<span class="line"><span style="color:#A6ACCD;">                message: &#39;获取列表成功&#39;,</span></span>
<span class="line"><span style="color:#A6ACCD;">                code: 200,</span></span>
<span class="line"><span style="color:#A6ACCD;">                data: [</span></span>
<span class="line"><span style="color:#A6ACCD;">                    { name: &#39;张三&#39;, age: 18 },</span></span>
<span class="line"><span style="color:#A6ACCD;">                    { name: &#39;李四&#39;, age: 20 },</span></span>
<span class="line"><span style="color:#A6ACCD;">                ]</span></span>
<span class="line"><span style="color:#A6ACCD;">            })</span></span>
<span class="line"><span style="color:#A6ACCD;">        }</span></span>
<span class="line"><span style="color:#A6ACCD;">    })</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    console.log(&#39;server is running 3000&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br></div></div>`,27),o=[p];function r(t,c,i,b,C,A){return n(),a("div",null,o)}const y=s(e,[["render",r]]);export{m as __pageData,y as default};
